...
export const Scene13LoveShayari2: React.FC<Scene13LoveShayari2Props> = ({
  ...
  return (
    ...
    >
      {/* Galaxy Nebular Glow */}
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] sm:w-[650px] h-[350px] sm:h-[650px] rounded-full bg-gradient-to-tr from-[#FF2A55]/20 via-[var(--c-accent-main)]/20 to-[#9B51E0]/15 blur-[140px] pointer-events-none" />
      ...
      <div className="shayari2-header pt-2 flex flex-col items-center space-y-1.5 shrink-0">
        <div className="flex items-center gap-2 text-[11px] sm:text-xs uppercase tracking-[0.25em] text-[var(--c-accent-light)]/90 font-semibold">
          <Moon className="w-3.5 h-3.5 text-[var(--c-accent-gold)]" />
      ...
      <div className="relative my-auto py-4 flex flex-col items-center max-w-sm sm:max-w-md w-full space-y-5">
        <div className="shayari2-parchment relative w-full p-6 sm:p-7 rounded-3xl bg-gradient-to-b from-[#2C101F]/90 to-[#1A0813]/95 border-2 border-[var(--c-accent-main)]/40 shadow-[0_0_45px_rgba(232,137,157,0.3)] text-center backdrop-blur-md">
          {/* Top Heart Emblem & Dream Photo */}
          <div className="flex items-center justify-center gap-3 mb-4">
            {primaryPhoto && (
              <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-[var(--c-accent-gold)] shadow-[0_0_15px_rgba(216,160,108,0.5)]">
                <img
                  src={primaryPhoto}
                  alt="Our Dream Love"
            ...
            <div className="inline-flex p-3 rounded-full bg-[var(--c-accent-main)]/20 border border-[var(--c-accent-main)]/40 shadow-inner">
              <Heart className="w-6 h-6 text-[#FF2A55] fill-[#FF2A55] animate-pulse-heart" />
            </div>
          </div>

          <div className="space-y-4 text-[var(--c-text-main)]">
            <p className="font-serif text-lg sm:text-xl leading-relaxed text-[var(--c-text-main)]">
              &ldquo;Na chaand ki chahat, <br />
              Na taaron ki farmaish hai...&rdquo;
            </p>

            <p className="font-serif text-lg sm:text-xl leading-relaxed text-[var(--c-accent-gold)] font-semibold">
            ...
            <div className="pt-2 border-t border-[var(--c-accent-main)]/20">
              <p className="font-serif text-sm sm:text-base text-[var(--c-accent-light)] leading-relaxed italic">
        ...
        <div className="w-full space-y-2">
          <p className="text-[11px] text-[var(--c-accent-gold)] uppercase tracking-wider font-semibold">
            ...
            {miniQuotes.map((q, idx) => (
              <div
                ...
                className={`quote-pill-item p-3 rounded-2xl transition-all cursor-pointer text-left border ${
                  selectedQuote === idx
                    ? 'bg-gradient-to-r from-[var(--c-accent-main)]/30 to-[var(--c-accent-gold)]/30 border-[var(--c-accent-main)] shadow-[0_0_15px_rgba(232,137,157,0.3)] scale-[1.02]'
                    : 'bg-[#1C0B14]/70 border-white/10 opacity-75 hover:opacity-100 hover:border-white/20'
                }`}
              >
                <p className="text-xs sm:text-sm font-serif font-bold text-[var(--c-text-main)]">
                  &ldquo;{q.text}&rdquo;
                </p>
                <p className="text-[11px] text-[var(--c-accent-light)]/80 italic pt-0.5">
                  {q.sub}
                </p>
              </div>
            ))}
