...
export const Scene11LoveShayari1: React.FC<Scene11LoveShayari1Props> = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] sm:w-[600px] h-[350px] sm:h-[600px] rounded-full bg-gradient-to-tr from-[var(--c-accent-main)]/20 via-[#FF2A55]/15 to-[var(--c-accent-gold)]/20 blur-[130px] pointer-events-none" />

      {/* Top Header */}
      <div className="shayari-header pt-2 flex flex-col items-center space-y-1.5">
        <div className="flex items-center gap-2 text-[11px] sm:text-xs uppercase tracking-[0.25em] text-[var(--c-accent-light)]/90 font-semibold">
      ...
      <div className="relative my-auto py-4 flex flex-col items-center max-w-sm sm:max-w-md w-full space-y-5">
        <div className="shayari-card relative w-full p-6 sm:p-7 rounded-3xl bg-gradient-to-b from-[#2A101D]/90 to-[#1C0B14]/95 border-2 border-[var(--c-accent-main)]/40 shadow-[0_0_40px_rgba(232,137,157,0.25)] text-left backdrop-blur-md">
          {/* Decorative Corner Stars */}
          <div className="absolute top-3 left-3 text-[var(--c-accent-gold)]/40 flex gap-1">
            <Star className="w-3 h-3 fill-current" />
          </div>
          <div className="absolute top-3 right-3 text-[var(--c-accent-gold)]/40 flex gap-1">
            <Star className="w-3 h-3 fill-current" />
          </div>
          
          <div className="flex items-center justify-between border-b border-[var(--c-accent-main)]/20 pb-3 mb-4">
            <div className="flex items-center gap-2.5">
              {primaryPhoto && (
                <div className="w-10 h-10 rounded-full overflow-hidden border border-[var(--c-accent-gold)] shrink-0 shadow-sm">
                  <img
                    src={primaryPhoto}
                    alt="Couple Dream"
              ...
              <div className="text-xs font-semibold text-[var(--c-accent-gold)] uppercase tracking-wider flex items-center gap-1.5">
                <Quote className="w-3.5 h-3.5 rotate-180 text-[var(--c-accent-main)]" />
                <span>For {config.partnerName}</span>
              </div>
            </div>
            <span className="text-[10px] px-2.5 py-0.5 rounded-full bg-[var(--c-accent-main)]/15 text-[var(--c-accent-light)] border border-[var(--c-accent-main)]/30">
              Tap lines to feel ✨
            </span>
          </div>
          ...
          <div className="space-y-3.5 text-[var(--c-text-main)]">
            <div
              ...
              className={`shayari-line p-2.5 rounded-xl transition-all cursor-pointer ${
                activeVerse === 0 ? 'bg-[var(--c-accent-main)]/25 border border-[var(--c-accent-main)]/50 scale-[1.02]' : 'hover:bg-white/5'
              }`}
            >
            ...
            <div
              ...
              className={`shayari-line p-2.5 rounded-xl transition-all cursor-pointer ${
                activeVerse === 1 ? 'bg-[var(--c-accent-main)]/25 border border-[var(--c-accent-main)]/50 scale-[1.02]' : 'hover:bg-white/5'
              }`}
            >
              <p className="font-serif text-base sm:text-lg leading-relaxed text-[var(--c-text-main)]">
                &ldquo;Manga tha rab se ek saccha humsafar zindagi bhar ke liye,
              </p>
              <p className="font-serif text-base sm:text-lg leading-relaxed text-[var(--c-accent-gold)] font-semibold">
          ...
          <div className="mt-5 pt-3 border-t border-[var(--c-accent-main)]/20 flex items-start gap-2.5 text-xs text-[var(--c-accent-light)]/80 italic">
        ...
        <div className="flex items-center gap-2 text-xs text-[var(--c-accent-light)]/70 font-script text-base">
          <span>Forever Yours,</span>
          <span className="text-[var(--c-text-main)] font-bold">{config.yourName}</span>
        </div>
      </div>
